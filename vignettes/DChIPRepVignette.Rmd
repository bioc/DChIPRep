...
The package implements the analysis strategy of  `r citep("10.15252/msb.20145776") `. 
Along with an experimental protocol to multiplex ChIP--Seq experiments, 
`r citep("Chabbert_2015")` developped a methodology to assess differences 
...
for the mean `r citep("10.1016/j.csda.2010.05.001")`. 
...
This plot is similar to Figure S17B of `r citep("Chabbert_2015")`. We see an 
...
This plot is similar to Figure 5B of `r citep("Chabbert_2015")`.
...
```{r writeBibliography, echo=FALSE, message=FALSE, eval=FALSE}
write.bibtex(file="references.bib")
```

# References

```{r refs, results='asis', echo=FALSE, message=FALSE, eval=TRUE}
bibliography()
```
